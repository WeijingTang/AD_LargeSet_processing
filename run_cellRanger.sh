...
#SBATCH --job-name="run_cellranger_no_intron"
...
FOLDER=/scratch/groups/icobos/Marazzi_lab/Quantification/Exon/
cd ${FOLDER}
...
/scratch/groups/icobos/Marazzi_lab/Cell_Ranger_5.0/cellranger-5.0.0/cellranger count --id=$SAMPLE --transcriptome=/scratch/groups/icobos/Marazzi_lab/Mouse_reference/mm10 --fastqs=${FOLDER}/${SAMPLE}_concat --sample=$SAMPLE --expect-cells=10000
